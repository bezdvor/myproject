...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 14 2018 г., 23:34
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='for user registration' AUTO_INCREMENT=2147483647 ;
...
(2147483647, 'vika', 'vika@gmail.com', '123456', 1);
